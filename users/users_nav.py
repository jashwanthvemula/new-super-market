...
class UserNavigation:
    ...
    def setup_sidebar(self):
        ...
        self.sidebar = ctk.CTkFrame(self.parent, width=200, height=700, corner_radius=0, fg_color="#2563eb")
        self.sidebar.pack(side="left", fill="y")
        self.sidebar.pack_propagate(False)  # Prevent the frame from shrinking

        # Sidebar Title
        title_label = ctk.CTkLabel(self.sidebar, text="SuperMarket", font=("Arial", 24, "bold"), text_color="white")
    ...
    def navigate_to(self, destination):
        # This method will be overridden in the users_view.py file
        pass